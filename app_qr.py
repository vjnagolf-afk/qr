...
# ============================================================
st.sidebar.markdown("### 📌 DANH MỤC CÔNG CỤ")
...
if chuc_nang == "📱 Tạo Mã QR Tùy Biến":
    st.markdown("""
        <div class="main-header">
            ...
            <p>⚡ Trợ lý Tạo Mã QR Sạch, không QC & Tùy Biến màu sắc, tên tác giả</p>
        </div>
    """, unsafe_allow_html=True)
    ...
    if target_link:
        ...
        st.info("💡 Thầy/Cô hãy nhập link và tên tác giả để tạo mã QR nhé!")
...
# ============================================================
    ...
    st.markdown("""
        <div class="main-header">
            ...
            <p>⚡ Thư viện câu lệnh (Prompt) chuẩn hóa tối ưu hóa AI trong giáo dục</p>
        </div>
    """, unsafe_allow_html=True)
...
Đánh dấu mức độ (Có/Không) và mô tả cụ thể."""
            ...
            st.info("💡 **Cách dùng:** Copy đoạn prompt dưới đây, điền nội dung bài học rồi dán vào Gemini. Sau đó, copy kết quả dàn ý từ Gemini dán thẳng vào Gamma.app hoặc Canva (Magic Design) để AI tự động tạo hình ảnh và slide trong 1 phút.")
...
st.markdown("---")
st.markdown(
    "<p style='text-align: center; color: gray; font-size: 14px;'>Được thiết kế riêng phục vụ công tác chuyên môn - Trường THCS Nguyễn Chí Thanh 🏫</p>",
    unsafe_allow_html=True
)
